...
import com.shanthi.onlinegrocerystore.config.JwtUtil;
...
import com.shanthi.onlinegrocerystore.service.CartItemService;
import com.shanthi.onlinegrocerystore.service.JwtUserDetailsService;
import com.shanthi.onlinegrocerystore.service.ProductService;
import com.shanthi.onlinegrocerystore.service.UserService;
...
public class GroceryController {
    ...
    public GroceryController(UserService userService, ProductService productService, CartItemService cartItemService) {
    ...
    public ResponseEntity<List<Product>> createProducts () {
		...
		try {
			final File folder = new File("F:/Demo/onlinegrocerystore/src/main/resources/products");
				...
				for (final File fileEntry : folder.listFiles()) {
					 BufferedImage bImage = ImageIO.read(fileEntry);
				      ...
				      if(data!=null) {
				    	  ...
				    	  product.setDescription(fileEntry.getName());
